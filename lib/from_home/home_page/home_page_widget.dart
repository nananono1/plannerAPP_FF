                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed(StudentAnalyticsWidget.routeName);
                          },
                          child: Container(
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    return AlertDialog(
                                                                      title: Text(
                                                                          '디데이 삭제'),
                                                                      content: Text(
                                                                          '\'${dDayListItem.ddayInfo}\' 디데이를 삭제하시겠습니까?'),
                                                                      actions: [
                                                                        TextButton(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final containerWeeklyRankRecord =
                                    containerWeeklyRankRecordList.isNotEmpty
                                        ? containerWeeklyRankRecordList.first
                                        : null;
                            ...
                            child: FutureBuilder<List<MonthlyRankRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final containerMonthlyRankRecord =
                                    containerMonthlyRankRecordList.isNotEmpty
                                        ? containerMonthlyRankRecordList.first
                                        : null;
 ...
 */
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      context.pushNamed(AdminSeatConfigureWidget.routeName);
                    },
                    child: Container(
                      width: double.infinity,
                      height: 400.0,
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed(AdminplannerPageWidget.routeName);
                        },
                        child: Row(
                          mainAxisSize: MainAxisSize.max,
                          children: [
