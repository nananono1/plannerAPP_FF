...
import 'weekly_to_capture_model.dart';
export 'weekly_to_capture_model.dart';

class WeeklyToCaptureWidget extends StatefulWidget {
  const WeeklyToCaptureWidget({super.key});

  @override
  State<WeeklyToCaptureWidget> createState() => _WeeklyToCaptureWidgetState();
}

class _WeeklyToCaptureWidgetState extends State<WeeklyToCaptureWidget> {
  late WeeklyToCaptureModel _model;
 ...
 */
          ...
          Container(
            ...
            child: Padding(
              padding: EdgeInsetsDirectional.fromSTEB(30.0, 30.0, 35.0, 30.0),
              child: Column(
                mainAxisSize: MainAxisSize.max,
                            ...
                            child: RichText(
                              ...
                              text: TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text: FFAppState().setnum.toString(),
                                    style: TextStyle(),
                                  ),
                                  TextSpan(
                                    text: FFLocalizations.of(context).getText(
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text: valueOrDefault<String>(
                              FFAppState().rapidClickAvoidCount.toString(),
                              '좌석',
                            ),
                            style: TextStyle(),
                          ),
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                's123t0do' /* 학습 내용 및 태도를 입력해 주세요(최대 10줄) */,
                              ),
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              '2pk8q1uh' /* 주간공지사항을 입력해주세요.(최대 20줄) */,
                            ),
                            enabledBorder: OutlineInputBorder(
                              borderSide: BorderSide(
                                color: Color(0x00000000),
