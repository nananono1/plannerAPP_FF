...
class Sign2Widget extends StatefulWidget {
  ...
  static String routeName = 'sign2';
  static String routePath = '/sign2';
...
class _Sign2WidgetState extends State<Sign2Widget> {
  ...
  void initState() {
    ...
    _model.textFieldschoolTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      valueOrDefault(currentUserDocument?.school, ''),
      '내공스쿨',
    ));
    _model.textFieldschoolFocusNode ??= FocusNode();

    _model.addressTextController ??= TextEditingController();
    _model.addressFocusNode ??= FocusNode();

    _model.textFielddadTextController ??= TextEditingController();
    _model.textFielddadFocusNode ??= FocusNode();

    _model.textFielddadMask = MaskTextInputFormatter(mask: '###-####-####');
    _model.textFieldmomTextController ??= TextEditingController();
    _model.textFieldmomFocusNode ??= FocusNode();

    _model.textFieldmomMask = MaskTextInputFormatter(mask: '###-####-####');
    ...
    _model.parentsNameTextController ??= TextEditingController();
    _model.parentsNameFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
                                          ...
                                          children: [
                                            AuthUserStreamWidget(
                                              builder: (context) => Container(
                                                ...
                                                child: TextFormField(
                                                  controller: _model
                                                      .textFieldschoolTextController,
                                                  focusNode: _model
                                                      .textFieldschoolFocusNode,
                                                  autofocus: false,
                                                  obscureText: false,
                                                  decoration: InputDecoration(
                                                    isDense: true,
                                    ...
                                    Expanded(
                                      ...
                                      child: Container(
                                        ...
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            controller: _model
                                                .textFielddadTextController,
                                            focusNode:
                                                _model.textFielddadFocusNode,
                                            autofocus: false,
                                            obscureText: false,
                                            decoration: InputDecoration(
                                              isDense: true,
                                            ...
                                            cursorColor:
                                                FlutterFlowTheme.of(context)
                                                    .primaryText,
                                            validator: _model
                                                .textFielddadTextControllerValidator
                                                .asValidator(context),
                                            inputFormatters: [
                                              _model.textFielddadMask
                                            ],
                                          ),
                                        ),
                                      ),
                                    ...
                                    Expanded(
                                      ...
                                      child: Container(
                                        ...
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            controller: _model
                                                .textFieldmomTextController,
                                            focusNode:
                                                _model.textFieldmomFocusNode,
                                            autofocus: false,
                                            obscureText: false,
                                            decoration: InputDecoration(
                                              isDense: true,
                                            ...
                                            cursorColor:
                                                FlutterFlowTheme.of(context)
                                                    .primaryText,
                                            validator: _model
                                                .textFieldmomTextControllerValidator
                                                .asValidator(context),
                                            inputFormatters: [
                                              _model.textFieldmomMask
                                            ],
                                          ),
                                        ),
                                      ),
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                hintText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'qm6l2h7e' /* 준비 중인 시험 혹은 목표를 입력해주세요. */,
                                                ),
                                                hintStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  .textFieldETCTextController,
                                              focusNode:
                                                  _model.textFieldETCFocusNode,
                                              autofocus: false,
                                              obscureText: false,
                                              decoration: InputDecoration(
                                                isDense: true,
                                                ...
                                                hintText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  '8hhttlll' /* 준비 중인 시험 혹은 목표를 입력해주세요. */,
                                                ),
                                                hintStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
    ...
    - 환불 금액 = 결제 금액 – ... */
                                          ...
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'mv4lv98q' /* * 사용자가 서약서 사항 위반하여 벌점이 20점 이상 ... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'ktsoxrcu' /* 결제 전 본 내용에 대해 고지 및 설명을 받았으며, 이... */,
                                                  ),
                                                  style:
                                                      FlutterFlowTheme.of(
                                                              context)
