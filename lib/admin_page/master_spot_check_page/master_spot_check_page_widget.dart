...
import 'master_spot_check_page_model.dart';
export 'master_spot_check_page_model.dart';

class MasterSpotCheckPageWidget extends StatefulWidget {
  const MasterSpotCheckPageWidget({super.key});

  static String routeName = 'masterSpotCheckPage';
  static String routePath = '/masterSpotCheckPage';

  @override
  State<MasterSpotCheckPageWidget> createState() =>
      _MasterSpotCheckPageWidgetState();
}

class _MasterSpotCheckPageWidgetState extends State<MasterSpotCheckPageWidget> {
  late MasterSpotCheckPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MasterSpotCheckPageModel());
