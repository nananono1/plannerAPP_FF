...
import 'admin_sign_check_model.dart';
export 'admin_sign_check_model.dart';

class AdminSignCheckWidget extends StatefulWidget {
  const AdminSignCheckWidget({super.key});

  static String routeName = 'adminSignCheck';
  static String routePath = '/adminSignCheck';

  @override
  State<AdminSignCheckWidget> createState() => _AdminSignCheckWidgetState();
}

class _AdminSignCheckWidgetState extends State<AdminSignCheckWidget>
    with TickerProviderStateMixin {
  late AdminSignCheckModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminSignCheckModel());
                                    ...
                                    itemBuilder: (context, userlistIndex) {
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          ...
                                          safeSetState(() {});
                                          safeSetState(() {
                                            _model.sign2captureModel
                                                .checkboxJungsiValue = false;
                                            _model.sign2captureModel
                                                .checkboxsusiValue = false;
                                            _model.sign2captureModel
                                                .checkboxCSATValue = false;
                                            _model.sign2captureModel
                                                .checkboxHARDWAYValue = false;
                                            _model.sign2captureModel
                                          ...
                                          _model.uid = userlistItem.reference;
                                          safeSetState(() {});
                                          _model.itemListSelected =
                                          ...
                                          if (valueOrDefault<String>(
                                            ...
                                            if (valueOrDefault<String>(
                                              ...
                                              safeSetState(() {
                                                _model.sign2captureModel
                                                    .checkboxJungsiValue = true;
                                              });
                                            } else {
                                              safeSetState(() {
                                                _model.sign2captureModel
                                                    .checkboxsusiValue = true;
                                              });
                                            }
                                          }
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: wrapWithModel(
                                        model: _model.sign2captureModel,
                                        updateCallback: () =>
                                            safeSetState(() {}),
                                        child: Sign2captureWidget(
                                          userParameter:
                                              _model.itemListSelected,
                                        ),
                                      ),
                                    ...
                                    Container(
                                      ...
                                      child: wrapWithModel(
                                        model: _model.secureSign2CaptureModel,
                                        updateCallback: () =>
                                            safeSetState(() {}),
                                        child: SecureSign2CaptureWidget(
                                          user2: _model.itemListSelected,
                                        ),
                                      ),
                                    ),
