...
import 'adminpm_call_check_model.dart';
export 'adminpm_call_check_model.dart';

class AdminpmCallCheckWidget extends StatefulWidget {
  const AdminpmCallCheckWidget({super.key});

  static String routeName = 'adminpmCallCheck';
  static String routePath = '/adminpmCallCheck';

  @override
  State<AdminpmCallCheckWidget> createState() => _AdminpmCallCheckWidgetState();
}

class _AdminpmCallCheckWidgetState extends State<AdminpmCallCheckWidget>
    with TickerProviderStateMixin {
  late AdminpmCallCheckModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminpmCallCheckModel());
                                                            ...
                                                            child:
                                                              ...
                                                              builder: (context) =>
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  final dropDownNotificationRecord = dropDownNotificationRecordList
                                                                          .isNotEmpty
                                                                      ? dropDownNotificationRecordList
                                                                          .first
                                                                      : null;
                                                                  ...
                                                                  return FlutterFlowDropDown<
                                                                    ...
                                                                    options: _model.checkUserClaimAction ==
                                                                            'master'
                                              ...
                                              Align(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    ...
                                                    safeSetState(() {});
                                                    _model.apiResultmak =
                                                        await RealtimeDatabaseReadListLogicCall
                                                            .call(
                                                      spot:
                                                          _model.dropDownValue,
                                                    );
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            ...
                                            return ListView.builder(
                                              ...
                                              itemCount: erw.length,
                                              itemBuilder: (context, erwIndex) {
                                                final erwItem = erw[erwIndex];
                                                return Container(
                                                  width: 100.0,
                                                  height: 60.0,
                                                  decoration: BoxDecoration(
