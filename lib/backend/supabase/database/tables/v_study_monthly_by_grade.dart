...
class VStudyMonthlyByGradeTable extends SupabaseTable<VStudyMonthlyByGradeRow> {
  @override
  String get tableName => 'v_study_monthly_by_grade';

  @override
  VStudyMonthlyByGradeRow createRow(Map<String, dynamic> data) =>
      VStudyMonthlyByGradeRow(data);
}

class VStudyMonthlyByGradeRow extends SupabaseDataRow {
  VStudyMonthlyByGradeRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VStudyMonthlyByGradeTable();
