...
class VStudyMonthlyOverallTable extends SupabaseTable<VStudyMonthlyOverallRow> {
  @override
  String get tableName => 'v_study_monthly_overall';

  @override
  VStudyMonthlyOverallRow createRow(Map<String, dynamic> data) =>
      VStudyMonthlyOverallRow(data);
}

class VStudyMonthlyOverallRow extends SupabaseDataRow {
  VStudyMonthlyOverallRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VStudyMonthlyOverallTable();
