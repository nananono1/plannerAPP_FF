...
class VStudyWeeklyByForwhatTable
    extends SupabaseTable<VStudyWeeklyByForwhatRow> {
  @override
  String get tableName => 'v_study_weekly_by_forwhat';

  @override
  VStudyWeeklyByForwhatRow createRow(Map<String, dynamic> data) =>
      VStudyWeeklyByForwhatRow(data);
}

class VStudyWeeklyByForwhatRow extends SupabaseDataRow {
  VStudyWeeklyByForwhatRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VStudyWeeklyByForwhatTable();
