...
export '/from_home/auth_login/auth_login_widget.dart' show AuthLoginWidget;
...
export '/admin_page/adminplanner_page/adminplanner_page_widget.dart'
    show AdminplannerPageWidget;
export '/admin_page/admin_seat_change/admin_seat_change_widget.dart'
    show AdminSeatChangeWidget;
export '/admin_page/admin_point_configure_page/admin_point_configure_page_widget.dart'
...
export '/temporary_lock_page/temporary_lock_page_widget.dart'
    show TemporaryLockPageWidget;
export '/from_home/home_page_copy/home_page_copy_widget.dart'
    show HomePageCopyWidget;
export '/secondpin_page/secondpin_page_widget.dart' show SecondpinPageWidget;
export '/timetable_select_page/timetable_select_page_widget.dart'
    show TimetableSelectPageWidget;
export '/admin_page/adminpm_call_check/adminpm_call_check_widget.dart'
    show AdminpmCallCheckWidget;
export '/admin_page/adminpm_study_check/adminpm_study_check_widget.dart'
...
export '/secure_sign_page/secure_sign_page_widget.dart'
