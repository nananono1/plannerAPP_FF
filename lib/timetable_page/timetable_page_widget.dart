...
import '/components/timetablecheck_widget.dart';
...
import 'timetable_page_model.dart';
export 'timetable_page_model.dart';

class TimetablePageWidget extends StatefulWidget {
  const TimetablePageWidget({
    super.key,
    this.indexpassed,
  });
  ...
  static String routeName = 'timetablePage';
  static String routePath = '/timetablePage';
...
class _TimetablePageWidgetState extends State<TimetablePageWidget>
  ...
  late TimetablePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TimetablePageModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.toggleon = false;
      safeSetState(() {});
      FFAppState().weeklyTimeTableChoice = currentUserDocument!.scheduleNow;
      FFAppState().update(() {});
      _model.tableToFix = currentUserDocument?.scheduleToChange;
      safeSetState(() {});
    });
              ...
              children: [
                Expanded(
                  child: Container(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(25.0, 60.0, 0.0, 40.0),
                      child: Column(
                        mainAxisSize: MainAxisSize.max,
