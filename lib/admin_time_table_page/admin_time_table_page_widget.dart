                                                                ...
                                                                queryBuilder:
                                                                    (usersRecord) =>
                                                                        usersRecord
                                                                            ...
                                                                            .where(
                                                                              'spot',
                                                                              isEqualTo: valueOrDefault(currentUserDocument?.spot, '') != '' ? valueOrDefault(currentUserDocument?.spot, '') : null,
                                                                            ),
                                                              ),
                                                              builder: (context,
                                                                  snapshot) {
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          options: _model.checkusercalimaction == 'master'
                                                                              ? adminTimeTablePageNotificationRecord!.spotdatas.map((e) => e.spot).toList()
                                                                              : ((String var1) {
                                                                                  return [
                                                                                    var1
                                                                                  ];
                                                                ...
                                                                Expanded(
                                                                  ...
                                                                  child: Align(
                                                                    ...
                                                                    child: Text(
                                                                      valueOrDefault<
                                                                          String>(
                                                                        usertimetableItem.scheduleChangeRequest
                                                                            ? 'O(수정요청)'
                                                                            : 'X(정상상태)',
                                                                        'X(정상상태)',
                                                                      ),
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        valueOrDefault<
                                                                          ...
                                                                          dateTimeFormat(
                                                                            "MM/dd H:mm",
                                                                            usertimetableItem.scheduleRequestTime,
                                                                            locale:
                                                      ...
                                                      _model.apicall =
                                                        ...
                                                        spotSheetLink:
                                                            adminTimeTablePageNotificationRecord
                                                                ...
                                                                .firstOrNull
                                                                ?.sheetRoot,
                                                        storekey: adminTimeTablePageNotificationRecord
                                                            ?.spotdatas
                                                            .where((e) =>
                                                                e.spot ==
                                                                valueOrDefault(
                                                                      ...
                                                                      Expanded(
                                                                        child:
                                                                          ...
                                                                          onChanged:
                                                                            ...
                                                                            safeSetState(() {});
                                                                            safeSetState(() {
                                                                              _model.checkboxValue = valueOrDefault<bool>(
                                                                                () {
                                                                          ...
                                                                          controller: _model.radioButtonValueController ??=
                                                                              FormFieldController<String>(FFLocalizations.of(context).getText(
                                                                            'pytjxmun' /* 월 */,
                                                                          )),
                                                                          optionHeight:
                                                                              30.0,
