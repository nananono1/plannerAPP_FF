  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<NotificationRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<NotificationRecord> userPageNotificationRecordList =
            snapshot.data!;
        final userPageNotificationRecord =
            userPageNotificationRecordList.isNotEmpty
                ? userPageNotificationRecordList.first
                : null;
                          ...
                          RichText(
                            ...
                            text: TextSpan(
                              children: [
                                ...
                                TextSpan(
                                  text: FFAppConstants.CurrentAppVersion
                                      .toString(),
                                  style: TextStyle(),
                                )
                              ],
                  ...
                  AuthUserStreamWidget(
                    builder: (context) => FutureBuilder<ApiCallResponse>(
                      future: GetFromSheetCall.call(
                        userDisplayName: '이서현',
                        spotSheetLink: userPageNotificationRecord?.spotdatas
                            .where((e) =>
                                e.spot ==
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          ...
                                          if ((_model.logoutupdate != null) ==
                                              true) {
                                            await _model.logoutupdate!.reference
                                                .update({
